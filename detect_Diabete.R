...
#Visualizing ROC curve to find an optimized cutoff: use ROC()
ROC(test_pred1, test$Outcome, plot = "ROC", AUC = T, main = "Logistic Regression")
#The result of this code suggests that diabetes is suspected if the probability is 0.338 or higher. 